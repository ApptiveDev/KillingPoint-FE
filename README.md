...
많은 사람들이 음악을 들을 때 특정 부분에 강하게 매료됩니다. 그 순간의 감동과 추억을 간직하고 싶지만, 기존의 방법으로는 그 순간을 제대로 기록하고 기억하기 어려웠습니다. **KillingPart는 가장 기억에 남는 순간을 기억할 수 있는 장치**를 제공합니다.

### 2. 기존 음악 공유 서비스의 한계
기존 음악 공유 서비스들은 대부분 **노래 전체를 공유**합니다. 인스타그램과 같은 플랫폼에서 부분 공유가 가능하더라도, 그것은 핵심 기능이 아닙니다. 우리는 음악의 **특정 킬링 파트만을 정확하게 공유**할 수 있는 서비스가 필요하다고 생각했습니다.
...
![youtube](https://img.shields.io/badge/youtube_player-FF0000?style=for-the-badge&logo=youtube&logoColor=white)
![coil](https://img.shields.io/badge/coil-000000?style=for-the-badge&logo=android&logoColor=white)

### 인증 & 저장소
![kakao](https://img.shields.io/badge/kakao_sdk-FFCD00?style=for-the-badge&logo=kakaotalk&logoColor=black)
...
![viewmodel](https://img.shields.io/badge/viewmodel-000000?style=for-the-badge&logo=android&logoColor=white)
